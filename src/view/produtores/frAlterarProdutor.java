 ...
 */
public class frAlterarProdutor extends javax.swing.JDialog {

    public int id = 0;
    
    public frAlterarProdutor(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        ...
        jPanel60Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel60Layout.createSequentialGroup()
                ...
                .addGroup(jPanel60Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(Nascimento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel60Layout.createSequentialGroup()
    ...
    private void btnConfirmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConfirmMouseClicked
     ...
     public boolean gravar() {
        if (txtNome.getText().matches("^[\\p{L} ]+$")) {
            ...
            return prodC.alterarProdutor(prod, id);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frAlterarProdutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frAlterarProdutor dialog = new frAlterarProdutor(new javax.swing.JFrame(), true, 0);
