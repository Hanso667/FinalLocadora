...
public class frUsuarios extends javax.swing.JDialog {
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        if (tblUsuarios.getSelectedRow() != -1) {
            ...
            int idUsuario = Integer.parseInt(textoCelula);
            new frAlterarUsuario(null, rootPaneCheckingEnabled, idUsuario).setVisible(true);
            pesquisar();
        } else {
    ...
    private void btnDeletarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeletarMouseClicked
        ...
        if (tblUsuarios.getSelectedRow() != -1) {
            ...
            String textoCelula = tblUsuarios.getValueAt(linhaSelecionada, 0).toString();
            int idUsuario = Integer.parseInt(textoCelula);
            if(JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar esse usuario?") == 0){
            usu.removerUsuario(idUsuario);
            }
            pesquisar();
        } else {
            JOptionPane.showMessageDialog(null, "Nenhum usuario selecionado");
