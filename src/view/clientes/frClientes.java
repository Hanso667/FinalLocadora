...
import view.usuarios.frAlterarUsuario;
...
public class frClientes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nome", "Cpf", "Telefone", "Endereço", "Data Cadastro"
            }
        ) {
        ...
        jScrollPane25.setViewportView(tblClientes);
    ...
    private void btnNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNovoMouseClicked
        new frNovoCliente(null, rootPaneCheckingEnabled).setVisible(true);
        pesquisar();
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        if (tblClientes.getSelectedRow() != -1) {
            ...
            new frAlterarCliente(null, rootPaneCheckingEnabled, idCliente).setVisible(true);
        } else {
    ...
    private void btnDeletarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeletarMouseClicked
        if (tblClientes.getSelectedRow() != -1) {
            ...
            String textoCelula = tblClientes.getValueAt(linhaSelecionada, 0).toString();
            int idCliente = Integer.parseInt(textoCelula);
            if (JOptionPane.showConfirmDialog(null, "tem certeza que deseja deletar este cliente?") == 0) {
                cli.removerCliente(idCliente);
            }
        } else {
            JOptionPane.showMessageDialog(null, "Nenhum usuario selecionado");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frClientes dialog = new frClientes(new javax.swing.JFrame(), true);
