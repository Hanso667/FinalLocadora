 ...
 */
public class frSelEditora extends javax.swing.JDialog {

    int value = 1;
    
    public frSelEditora(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnSelecionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSelecionarMouseClicked
        if (tblEditoras.getSelectedRow() != -1) {
            EditoraController produtor = new EditoraController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frSelEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frSelEditora dialog = new frSelEditora(new javax.swing.JDialog(), true);
