 ...
 */
public class frSelProdutor extends javax.swing.JDialog {

    int value = 1;
    
    public frSelProdutor(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblProdutores);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frSelProdutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frSelProdutor dialog = new frSelProdutor(new javax.swing.JDialog(), true);
