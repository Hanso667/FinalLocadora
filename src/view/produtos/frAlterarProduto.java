...
public class frAlterarProduto extends javax.swing.JDialog {
    ...
    public frAlterarProduto(javax.swing.JDialog parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        this.id = id;
    ...
    private void btnConfirmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConfirmMouseClicked
     ...
     public boolean gravar(){
        ...
        int ano = Integer.parseInt(txtAnoLançamento.getText());
        ...
        if (prodC.alterarProduto(prod, id)) {
            return true;
        } else {
            return false;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frAlterarProduto dialog = new frAlterarProduto(new javax.swing.JDialog(), true,0);
