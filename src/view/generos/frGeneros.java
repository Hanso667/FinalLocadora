 ...
 */
public class frGeneros extends javax.swing.JDialog {

    /**
     * Creates new form frGeneros
     */
    ...
    private void initComponents() {
        ...
        jScrollPane25.setViewportView(tblGeneros);
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        if (tblGeneros.getSelectedRow() != -1) {
            ...
            new frAlterarGenero(null, rootPaneCheckingEnabled, idGenero).setVisible(true);
        } else {
    ...
    private void btnNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNovoMouseClicked
        ...
        new frNovoGenero(null, rootPaneCheckingEnabled).setVisible(true);
        pesquisar();
    ...
    private void btnDeletarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeletarMouseClicked
        if (tblGeneros.getSelectedRow() != -1) {
            ...
            String textoCelula = tblGeneros.getValueAt(linhaSelecionada, 0).toString();
            int idGenero = Integer.parseInt(textoCelula);
            if (JOptionPane.showConfirmDialog(null, "tem certeza que deseja deletar esse genero?") == 0) {
                editora.removerGenero(idGenero);
            }
        } else {
            JOptionPane.showMessageDialog(null, "Nenhum genero selecionado");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frGeneros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frGeneros dialog = new frGeneros(new javax.swing.JFrame(), true);
