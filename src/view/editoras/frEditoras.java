...
import view.clientes.frAlterarCliente;

/**
 *
 * @author Cliente
 */
public class frEditoras extends javax.swing.JDialog {

    /**
     * Creates new form frEditoras
     */
    public frEditoras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane25.setViewportView(tblEditoras);
            ...
            .addGroup(jPanel50Layout.createSequentialGroup()
                ...
                .addGroup(jPanel50Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel50Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnVoltar, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        if (tblEditoras.getSelectedRow() != -1) {
            int linhaSelecionada = tblEditoras.getSelectedRow();
            String textoCelula = tblEditoras.getValueAt(linhaSelecionada, 0).toString();
            int idEditora = Integer.parseInt(textoCelula);
            new frAlterarEditora(null, rootPaneCheckingEnabled, idEditora).setVisible(true);
        } else {
    ...
    private void btnNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNovoMouseClicked
        ...
        new frNovaEditora(null, rootPaneCheckingEnabled).setVisible(true);
        pesquisar();
    ...
    private void btnDeletarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeletarMouseClicked
        if (tblEditoras.getSelectedRow() != -1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "tem certeza que deseja deletar essa editora?") == 0) {
                editora.removerEditora(idEditora);
            }
        } else {
    ...
    private void pesquisar() {
        ...
        // o 
        DefaultTableModel modeloTabela = (DefaultTableModel) tblEditoras.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frEditoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frEditoras dialog = new frEditoras(new javax.swing.JFrame(), true);
